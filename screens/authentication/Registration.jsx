...
const validationSchema = Yup.object().shape({
    ...
    username: Yup.string().min(3, "Username must at least 3 characters")
        .required('Required'),
    email: Yup.string()
                ...
                {({
                    ...
                    <View style={{ paddingTop: 30 }}>
                        ...
                        <View style={styles.wrapper}>
                            ...
                            <View>
                                <View style={styles.inpuWrapper(touched.username ? COLORS.lightBlue : COLORS.gray)}>
                                ...
                                {touched.username && errors.username && (
                                    <Text style={styles.errorMassge}>{errors.username}</Text>
                                )}
                            </View>
                        </View>
